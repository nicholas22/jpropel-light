 ...
 * 
 * Instantiate using e.g.: new LRUBuffer&lt;String&gt;(){}; -OR- new LRUBuffer&lt;String&gt;(String.class);
 */
    ...
    implements IBuffer<T>
{
  ...
  /**
   * Returns true if an object is contained in the buffer. This is an O(n) operation.
   * 
  ...
  /**
   * Returns the maximum size. This is an O(1) operation.
   */
  @Override
  ...
  /**
   * Returns true if the buffer is empty. This is an O(1) operation.
   */
  @Override
  ...
  /**
   * Returns true if the buffer is full. This is an O(1) operation.
   */
  @Override
  ...
  /**
   * Retrieves an object from the Buffer This method is not supported. Use get(int) instead.
   * 
  ...
  /**
   * Retrieves the object with specified index from the list. This is an O(1) operation.
   * 
  ...
  /**
   * Returns an iterator over the backing list. This is an O(1) operation.
   */
