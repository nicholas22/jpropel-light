 ...
 * <p/>
 * Note: if you override this class make sure that the add() method is not overridden in such a way that would prevent the
 * iterable-initialization constructors from adding elements in the linked list in a correct way. Overridden method calls from constructors
 * can be quite dangerous if you're not aware of the execution order.
 * 
 * Instantiate using e.g.: new ReifiedLinkedList&lt;String&gt;(){}; -OR- new ReifiedLinkedList&lt;String&gt;(String.class);
 */
    ...
    implements ReifiedList<T>
{
  ...
  /**
   * Returns a copy of this list. This is an O(n) operation.
   */
