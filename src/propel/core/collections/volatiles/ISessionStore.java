		...
		extends IShared
{
	 ...
	 * If the value is Timeout.Infinite then there is no expiration.
	 */
	int getExpirationMillis();

	/**
	 * The polling interval in milliseconds.
	 * If the value is Timeout.Infinite then there is no polling.
	 */
	 ...
	 * Item will be removed the next time the timer fires.
	 *
	 * @throws NullPointerException When the item is null.
	 */
