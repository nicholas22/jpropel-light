 ...
 * 
 * Instantiate using e.g.: new SharedAvlHashtable&lt;String, Object&gt;(){}; -OR- new SharedAvlHashtable&lt;String, Object&gt;(String.class,
 * Object.class);
 */
    ...
    implements ISharedHashtable<TKey, TValue>
{
  ...
  /**
   * Bulk add key/value pairs to avoid locking/unlocking continuously. Returns true for elements that were successfully added, false for
   * those that were not. You are advised not to use null keys, as these are not allowed and failing will leave the collection in an
   * inconsistent state. This is an O(mlog2(n)) operation where m is the provided element count, n is the hashtables's element Count.
   * 
  ...
  /**
   * Returns the value of a key, if found. Otherwise a null value is returned. This is an O(log2(n)) operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  @Override
  ...
  /**
   * Attempts to get the given key's value. If not found, then null is returned. This is an O(log2(n)) operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  @Override
  ...
  /**
   * Returns the value of a key, if found. Otherwise the specified defaultValue (E.g. null) is returned. This is an O(log2(n)) operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  @Override
  ...
  /**
   * Returns all key/value pairs in a list copy of key/value pairs. This is an O(n) operation.
   */
  @Override
  ...
  /**
   * Removes a value by its key. Returns true if successfully done, false if no such key. This is an O(log2(n)) operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  @Override
  ...
  /**
   * Removes a number of elements by key. Returns true for those successfully removed, false for those that there was no such key. You are
   * advised not to use null keys, as these are not allowed and failing will leave the collection in an inconsistent state. This is an
   * O(mlog2(n)) operation where m is the provided element count, n is the hashtables's element Count.
   * 
  ...
  /**
   * If the key is contained, the key/value pair is removed and the value returned. Otherwise null is returned. This is an O(log2(n))
   * operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  ...
  /**
   * If the key is contained, the key/value pair is removed and the value returned. Otherwise the specified defaultValue (E.g. null) is
   * returned. This is an O(log2(n)) operation.
   * 
   * @throws NullPointerException When the key is null.
   */
  @Override
  ...
  /**
   * Clears the hashtable and bulk adds key/value pairs to avoid locking/unlocking continuously. Returns true for elements that were
   ...
   * leave the collection in an inconsistent state. This is an O(mlog2(n)) operation where m is the provided element count, n is the
   * hashtables's element Count.
   * 
   * @throws NullPointerException When the keys or values argument is null.
  ...
  /**
   * Returns the size of the AVL hashtable. This is an O(1) operation.
   */
  @Override
  public int size()
  {
