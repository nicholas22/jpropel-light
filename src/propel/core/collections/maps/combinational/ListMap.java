 ...
 * to be inserted.
 * 
 * Instantiate using e.g.: new ListMap&lt;String, Object&gt;(){}; -OR- new ListMap&lt;String, Object&gt;(String.class, Object.class);
 */
    ...
    implements IListMap<TKey, TValue>
{
  ...
  /**
   * Adds an item to the collection. Returns true always. This is an O(1) operation.
   * 
  ...
  /**
   * Returns true if the given key is contained in the collection. This is an O(n) operation.
   * 
   * @throws NullPointerException If the key is null.
   */
  @Override
  ...
  /**
   * Returns the key's value if it exists, otherwise throws KeyNotFoundException. This is an O(n) operation.
   * 
  ...
  /**
   * Puts all keys in a list and returns them. Result order matches key/value pair insertion order. This is an O(1) operation.
   */
  @Override
  ...
  /**
   * Returns an iterator of the collection. This is an O(1) operation.
   */
  @Override
  ...
  /**
   * Sets a value at the specified index. This is an O(1) operation.
   * 
