 ...
 */
public class AsciiPrintablePropertyMetadata
    extends EncodedStringPropertyMetadata
{
   ...
   */
  public AsciiPrintablePropertyMetadata(String name, int minLength, int maxLength, boolean notNull, boolean notEmpty)
  {
    super(name, ArrayUtils.boxChars(StringUtils.charRange(32, 127)), minLength, maxLength, notNull, notEmpty, true);
  }
}
