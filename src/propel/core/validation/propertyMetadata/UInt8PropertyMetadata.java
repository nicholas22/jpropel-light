 ...
 */
public class UInt8PropertyMetadata
    extends BoundedValueTypePropertyMetadata<UnsignedByte>
{
  /**
   * Default constructor
   */
   ...
   */
  public UInt8PropertyMetadata(String name, UnsignedByte minValue, UnsignedByte maxValue, boolean notNull)
  {
