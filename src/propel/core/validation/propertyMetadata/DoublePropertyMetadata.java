...
public class DoublePropertyMetadata
    extends BoundedValueTypePropertyMetadata<Double>
{
  /**
   * Default constructor
   */
   ...
   */
  public DoublePropertyMetadata(String name, double minValue, double maxValue)
  {
   ...
   * @throws IllegalArgumentException An argument is invalid
   */
  public DoublePropertyMetadata(String name, Double minValue, Double maxValue, boolean notNull)
  {
