...
/**
 * A thread-safe object wrapper that can be used for capturing values used across multiple closure constructs e.g. when using multiple
 * anonymous classes. A wrapper is needed because these objects must be declared final, otherwise cannot be shared as such.
 * 
...
public class SharedClosureVariableWrapper<T>
{
   ...
   */
  public SharedClosureVariableWrapper(T item, Class<?> genericTypeParameter)
  {
    this.item = item;
