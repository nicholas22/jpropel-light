...
public final class ArrayUtils
{
  ...
  public static <T> T[][] create(T value, int lengthX, int lengthY)
   ...
   /**
    * Returns true if the provided object refers to a primitive array, e.g. int[].
    * This returns false for object arrays.
    *
    * @throws NullPointerException	 An argument is null
    * @throws IllegalArgumentException The argument is not a primitive or object array
    */
    ...
    * The array can be a primitive array, e.g. int[] or an object array e.g. Integer[]
    *
    * @throws NullPointerException	 An argument is null
    * @throws IllegalArgumentException The argument is not a primitive or object array
    */
    ...
    * Elements are sorted based on their Comparable implementation.
    *
    * @throws NullPointerException The array is null.
    */
    ...
    * Null references use default value false.
    *
    * @throws NullPointerException An argument is null
    */
   ...
   /**
    * Converts a Boolean sequence to primitive boolean[].
    * Null references use default value 0.
    *
    * @throws NullPointerException An argument is null
    */
    ...
    * Null references use default value 0.0
    *
    * @throws NullPointerException An argument is null
    */
