...
public final class EscapingUtils
{
  ...
  private static final KeyValuePair<String, String>[] HTML_PAIRS = Linq.cast(new Object[] {new KeyValuePair<String, String>("#", "&#035;"),
    ...
    new KeyValuePair<String, String>("@", "&#064;"), new KeyValuePair<String, String>("[", "&#091;"),
    new KeyValuePair<String, String>("\\", "&#092;"), new KeyValuePair<String, String>("]", "&#093;"),
    new KeyValuePair<String, String>("^", "&#094;"), new KeyValuePair<String, String>("_", "&#095;"),
    new KeyValuePair<String, String>("`", "&#096;"), new KeyValuePair<String, String>("{", "&#123;"),
    new KeyValuePair<String, String>("|", "&#124;"), new KeyValuePair<String, String>("}", "&#125;"),
    new KeyValuePair<String, String>("~", "&#126;")}, KeyValuePair.class);
  /**
   ...
   */
  @SuppressWarnings("unchecked")
  private static final KeyValuePair<String, String>[] URL_PAIRS = Linq.cast(new Object[] {
    new KeyValuePair<String, String>("%", "%25"), // do this first to avoid e.g. %2520 for %20
    new KeyValuePair<String, String>("\t", "%09"), new KeyValuePair<String, String>("\n", "%0A"),
    new KeyValuePair<String, String>("\r", "%0D"), new KeyValuePair<String, String>(" ", "%20"),
    new KeyValuePair<String, String>("!", "%21"), new KeyValuePair<String, String>("\"", "%22"),
    new KeyValuePair<String, String>("#", "%23"), new KeyValuePair<String, String>("$", "%24"),
    new KeyValuePair<String, String>("&", "%26"), new KeyValuePair<String, String>("'", "%27"),
    new KeyValuePair<String, String>("(", "%28"), new KeyValuePair<String, String>(")", "%29"),
    new KeyValuePair<String, String>("*", "%2A"), new KeyValuePair<String, String>("+", "%2B"),
    new KeyValuePair<String, String>(",", "%2C"), new KeyValuePair<String, String>("-", "%2D"),
    new KeyValuePair<String, String>(".", "%2E"), new KeyValuePair<String, String>("/", "%2F"),
    new KeyValuePair<String, String>(":", "%3A"), new KeyValuePair<String, String>(";", "%3B"),
    new KeyValuePair<String, String>("<", "%3C"), new KeyValuePair<String, String>("=", "%3D"),
    new KeyValuePair<String, String>(">", "%3E"), new KeyValuePair<String, String>("?", "%3F"),
    new KeyValuePair<String, String>("@", "%40"), new KeyValuePair<String, String>("[", "%5B"),
    new KeyValuePair<String, String>("\\", "%5C"), new KeyValuePair<String, String>("]", "%5D"),
    new KeyValuePair<String, String>("^", "%5E"), new KeyValuePair<String, String>("_", "%5F"),
    new KeyValuePair<String, String>("`", "%60"), new KeyValuePair<String, String>("{", "%7B"),
    new KeyValuePair<String, String>("|", "%7C"), new KeyValuePair<String, String>("}", "%7D"),
    new KeyValuePair<String, String>("~", "%7E")}, KeyValuePair.class);
  ...
  /**
   * Escapes a String for use in HTML Strings e.g. @ becomes &amp;#064; The idea is to avoid use of scripts embedded in the HTML.
   */
