...
public final class ConversionUtils
{
	...
	/**
	 * Conversion utility method, allows for a C# unsigned byte to
	 * be converted to a Java signed byte.
	 */
	...
	/**
	 * Conversion utility method, allows for a Java signed byte to
	 * be converted to a C# unsigned byte.
	 */
	 ...
	 * Works for most built-in types. Attempts to use casting for others.
	 *
  ...
  public static <T> T changeType(Object value, Class<T> targetType)
			throws InstantiationException, IllegalAccessException
	{
		...
		throw new IllegalArgumentException("The provided object of type '" + sourceType.getSimpleName() + "' could not be converted to '" + targetType.getSimpleName());
	}
	...
	public static LocalDateTime fromXMLGregorianCalendar(XMLGregorianCalendar value)
	{
		...
		return new LocalDateTime(value.getYear(), value.getMonth(), value.getDay(), value.getHour(), value.getMinute(), value.getSecond(), value.getMillisecond());
	}
			...
			throws DatatypeConfigurationException
	{
		...
		GregorianCalendar gc = new GregorianCalendar(value.getYear(), value.getMonthOfYear() - 1, value.getDayOfMonth(), value.getHourOfDay(), value.getMinuteOfHour(), value.getSecondOfMinute());
	...
	/**
	 * Converts a number to binary, e.g. 255 -> 11111111.
	 * Binary representations can be endian dependent.
	 */
	...
	/**
	 * Converts a number to hex, e.g. 255 -> FF.
	 * Hex representations can be endian dependent.
	 */
	...
	/**
	 * Converts a hex back to a ulong
	 * Hex representations can be endian dependent.
	 *
	 * @throws NullPointerException  An argument is null.
	 * @throws NumberFormatException A number could not be parsed.
	...
	/**
	 * Converts a hex back to a ushort
	 * Hex representations can be endian dependent.
	 *
	 * @throws NullPointerException  An argument is null.
	 * @throws NumberFormatException A number could not be parsed.
	...
	/**
	 * Converts a hex back to a short
	 * Hex representations can be endian dependent.
	 *
	 * @throws NullPointerException  An argument is null.
	 * @throws NumberFormatException A number could not be parsed.
	 ...
	 * Base64 representations can be endian dependent.
	 */
	...
	TODO: implement these
        ...
        // TODO: these are locale sensitive date formats

        /// <summary>
        /// Built-in date/time ToString styles.
        /// </summary>
        public enum DateTimeStyle
        {
            /// <summary>
            /// Displays e.g. 15/04/2008 for en-GB, 04/15/2008 for en-US, 4/15/2008 for en-NZ, 15.04.2008 for de-DE, etc.
            /// </summary>
            ShortDate,
            /// <summary>
            ...
            LongDate,
            /// <summary>
            /// Displays e.g. Thursday, April 10, 2008 6:30 AM for en-US, jeudi 10 avril 2008 06:30 for fr-FR
            /// </summary>
            FullDateShortTime,
            /// <summary>
            /// Displays e.g. Thursday, April 10, 2008 6:30:00 AM for en-US, jeudi 10 avril 2008 06:30:00 for fr-FR
            /// </summary>
            FullDateLongTime,
            /// <summary>
            /// Displays e.g. 4/10/2008 6:30 AM for en-US, 10/04/2008 6:30 for fr-BE
            /// </summary>
            GeneralDateShortTime,
            /// <summary>
            /// Displays e.g. 4/10/2008 6:30:00 AM for en-US, 10/04/2008 6:30:00 for nl-BE
            /// </summary>
            GeneralDateLongTime,
            /// <summary>
            /// Displays e.g. April 10 for en-US, 10 April for ms-MY
            /// </summary>
            MonthDay,
            /// <summary>
            /// Displays e.g. 2008-04-10T06:30:00.0000000 for a DateTime, 2008-04-10T06:30:00.0000000-07:00 for a DateTimeOffset
            /// </summary>
            RoundTrip,
            /// <summary>
            /// Displays e.g. Thu, 10 Apr 2008 13:30:00 GMT
            /// </summary>
            Rfc1123,
            /// <summary>
            /// Displays e.g. 2008-04-10T06:30:00
            /// </summary>
            Sortable,
            /// <summary>
            /// Displays e.g. 6:30 AM for en-US, 6:30 for es-ES
            /// </summary>
            ShortTime,
            /// <summary>
            /// Displays e.g. 6:30:00 AM for en-US, 6:30:00 AM for es-ES
            /// </summary>
            LongTime,
            /// <summary>
            /// Displays e.g. 2008-04-10 13:30:00Z
            /// </summary>
            UniversalSortable,
            /// <summary>
            /// Displays e.g. Thursday, April 10, 2008 1:30:00 PM for en-US, den 10 april 2008 13:30:00 for sv-FI
            /// </summary>
            UniversalFull,
            /// <summary>
            /// Displays e.g. April, 2008 for en-US, April 2008 for af-ZA
            /// </summary>
            YearMonth
        }
       */
	...
	/*
			...
			/// Example: 1000 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			...
			/// Example: 1000 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			public static String ToHumanReadable(ulong number)
			{
				return number.ToString("N0");
			}
			...
			/// Example: 1000 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			public static String ToHumanReadable(uint number)
			{
				return number.ToString("N0");
			}
			...
			/// Example: 1000 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			public static String ToHumanReadable(ushort number)
			{
				return number.ToString("N0");
			}
			...
			/// <summary>
			/// Returns the value of the given number in a human-readable form.
			/// Example: 1000.00 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			...
			/// <summary>
			/// Returns the value of the given number in a human-readable form.
			/// Example: 1000.00 becomes 1,000.00 (UK locale) or 1.000,00 (US) for 2 decimal places.
			/// </summary>
			...
			/// Example: 1000.00 becomes 1,000 (UK locale) or 1.000 (US).
			/// </summary>
			public static String ToHumanReadable(decimal number)
			{
				return number.ToString("N0");
			}
			...
			/// Example: 1000.00 becomes 1,000.00 (UK locale) or 1.000,00 (US) for 2 decimal places.
			/// </summary>
			public static String ToHumanReadable(decimal number, int decimalPlaces)
			{
				return number.ToString("N" + decimalPlaces);
			}

			/// <summary>
			/// Returns the date/time value in a human-readable and standard form,
			/// as specified by the given style selection. Uses current thread locale.
			/// </summary>
			public static String ToHumanReadable(DateTime dateTime, DateTimeStyle style)
			{
				return ToHumanReadable(dateTime, style, CultureInfo.CurrentCulture);
			}

			/// <summary>
			/// Returns the date/time value in a human-readable and standard form,
			/// as specified by the given style selection. Uses current specified locale.
			/// </summary>
			/// <exception cref="ArgumentException">Unrecognized date/time style used.</exception>
			public static String ToHumanReadable(DateTime dateTime, DateTimeStyle style, CultureInfo cultureInfo)
			{
				switch(style)
				{
					case DateTimeStyle.ShortDate:
						return dateTime.ToString("d", cultureInfo);
					case DateTimeStyle.LongDate:
						return dateTime.ToString("D", cultureInfo);
					case DateTimeStyle.FullDateShortTime:
						return dateTime.ToString("f", cultureInfo);
					case DateTimeStyle.FullDateLongTime:
						return dateTime.ToString("F", cultureInfo);
					case DateTimeStyle.GeneralDateShortTime:
						return dateTime.ToString("g", cultureInfo);
					case DateTimeStyle.GeneralDateLongTime:
						return dateTime.ToString("G", cultureInfo);
					case DateTimeStyle.MonthDay:
						return dateTime.ToString("m", cultureInfo);
					case DateTimeStyle.RoundTrip:
						return dateTime.ToString("o", cultureInfo);
					case DateTimeStyle.Rfc1123:
						return dateTime.ToString("r", cultureInfo);
					case DateTimeStyle.Sortable:
						return dateTime.ToString("s", cultureInfo);
					case DateTimeStyle.ShortTime:
						return dateTime.ToString("t", cultureInfo);
					case DateTimeStyle.LongTime:
						return dateTime.ToString("T", cultureInfo);
					case DateTimeStyle.UniversalSortable:
						return dateTime.ToString("u", cultureInfo);
					case DateTimeStyle.UniversalFull:
						return dateTime.ToString("U", cultureInfo);
					case DateTimeStyle.YearMonth:
						return dateTime.ToString("y", cultureInfo);
					default:
						throw new ArgumentException("Unrecognized date/time format: " + style);
				}
			}
			*/
	...
	private static Object changeTypeFromCharacter(Object value, Class<?> targetType)
	{
		...
		throw new IllegalArgumentException("The provided Character could not be converted to type '" + targetType.getSimpleName() + "': " + value);
	}
