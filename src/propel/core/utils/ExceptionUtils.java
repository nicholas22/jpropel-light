...
public final class ExceptionUtils
{
  ...
  /**
   * Gets all exception types and messages (top-level first, then inner) as an array of strings, e.g. MethodInvocationException: The method
  ...
  /**
   * Gets all exception messages (top-level first, then inner) as a string delimited with the specified string. e.g.
   * MethodInvocationException: The method could not be invoked. [CRLF] e.g. IndexOutOrBoundsException: The provided index was outside the
   * expected bounds.
   */
  ...
  /**
   * If the Exception's inner exception is set, throws the inner exception. Otherwise throws the exception itself.
   */
