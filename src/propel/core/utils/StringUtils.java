...
public final class StringUtils
{
    ...
    */
   public static final DateTimeFormatter STANDARD_FORMATTERS = (new DateTimeFormatterBuilder()).append(null, createCommonDateTimeParsers()).toFormatter();
   ...
   /**
    * Concatenates a collection of strings into a single string.
    * Substitutes null items with the null-replacement value provided, if not null.
    *
    ...
    * Returns String.Empty if an empty collection was provided.
    *
    * @throws NullPointerException An argument is null.
    */
   ...
   /**
    * Concatenates the given chars.
    * Returns an empty array if no chars are found.
    *
    ...
    * Uses CurrentLocale string comparison.
    *
    * @throws NullPointerException An argument is null.
    */
   ...
   /**
    * Returns true if the part is contained in the value.
    * Uses culture-aware higher performance string comparison.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * Uses the specified string comparison mode.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * Order is not taken into consideration.
    * Uses the CurrentLocale StringComparison.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * Returns true if all strings specified are contained in the value string.
    * Order is not taken into consideration.
    * If a part is null then false is returned.
    *
    * @throws NullPointerException An argument is null.
    */
   public static boolean containsAll(String value, Iterable<String> parts, StringComparison stringComparison)
   {
      ...
      for (String part : parts)
         if (part == null)
            ...
            if (indexOf(value, part, 0, value.length(), stringComparison) < 0)
               return false;
   ...
   public static boolean containsAll(String value, Iterable<String> parts, Locale locale, Collator collator, boolean caseSensitive)
   {
      ...
      for (String part : parts)
         if (part == null)
            ...
            if (indexOf(value, part, 0, value.length(), locale, collator, caseSensitive) < 0)
               return false;
    ...
    * Order is not taken into consideration. You may use null elements for both values and items.
    * Uses CurrentLocale string comparison.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * Order is not taken into consideration. You may use null elements for values and items.
    * Uses a culture-aware higher performance string comparison.
    *
    * @throws NullPointerException An argument is null.
    */
   public static boolean containsAll(Iterable<String> values, Iterable<String> items, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (values == null)
         throw new NullPointerException("values");
      if (items == null)
   ...
   /**
    * Returns true if any of the strings are contained in a string.
    * Order is not taken into consideration. If a part is null then it is ignored.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * Order is not taken into consideration.
    * You may use null elements for values and items.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * @throws NullPointerException An argument is null.
    */
   public static boolean containsAny(Iterable<String> values, Iterable<String> items, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (values == null)
         throw new NullPointerException("values");
      if (items == null)
   ...
   /**
    * Returns CR, LF or CRLF, depending on the frequency of 
    * line separators found in the given text data.
    *
    * @throws NullPointerException	  An argument is null.
    */
    ...
    * Returns CR, LF or CRLF, depending on the frequency of 
    * line separators found in the given text data.
    * Accepts a ratio, to ensure the decision is not swayed by
    * CRs or LFs appearing randomly in the code. 
    * For example a value of 2.0f for a CR End-Of-Line (EOL) 
    * terminated file would return CR if the file contains 
    * twice the number of CRs than the number of LFs.
    *
    * @throws NullPointerException	  An argument is null.
    */
   ...
   /**
    * Concatenates the given chars with
    * the given delimiter between all values.
    * Returns String.Empty if an empty or null collection was provided.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * If the part is not existent, -1 is returned.
    * Uses the CurrentLocale string comparison.
    *
    * @throws NullPointerException An argument is null.
    */
   ...
   /**
    * Returns the first, second, third, etc. index where a part is encountered within a string value,
    * starting at the specified index and moving to the right of the string.
    * If the part is not existent, -1 is returned.
    * Uses the specified string comparison.
    *
    * @throws NullPointerException An argument is null.
    ...
    * @throws IllegalArgumentException  An argument is out of range
    */
   private static int indexOfLocaleSensitive(String value, String part, int startIndex, int count, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (locale == null)
         throw new NullPointerException("locale");
      if (collator == null)
      ...
      if (caseSensitive)
         ...
         for (int i = startIndex; i < endIndex; i++)
            ...
            // e.g. for US: "\u00C4" "LATIN CAPITAL LETTER A WITH DIAERESIS" (Ä) and "\u0041\u0308" "LATIN CAPITAL LETTER A" (A) - "COMBINING DIAERESIS" (̈)
   ...
   /**
    * Returns the first, second, third, etc. index where a part is encountered within a string value,
    * starting at the specified index and moving to the left of the string.
    * If the part is not existent, -1 is returned.
    * Uses the specified string comparison.
    *
    * @throws NullPointerException	  An argument is null.
    ...
    * @throws IllegalArgumentException  An argument is out of range
    */
   public static int lastIndexOf(String value, String part, int startIndex, int count, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (value == null)
         throw new NullPointerException("value");
      if (part == null)
    ...
    * @throws IllegalArgumentException  An argument is out of range
    */
   private static int lastIndexOfLocaleSensitive(String value, String part, int startIndex, int count, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (locale == null)
         throw new NullPointerException("locale");
      if (collator == null)
   ...
   public static boolean parseBool(String value, String trueValue, String falseValue, StringComparison comparisonType)
   {
      ...
      if (equal(trueValue, value, comparisonType))
         ...
         if (equal(falseValue, value, comparisonType))
            return false;
    ...
    * Uses common ISO formats as well as some locale-specific formats.	See http://joda-time.sourceforge.net/apidocs/org/joda/time/format/DateTimeFormat.html
    * ISO format examples:
    * <ul>
   ...
   public static BigDecimal parseDecimal(String value)
   {
      ...
      try {
         ...
         if (DECIMAL_SEPARATOR != CONSTANT.COMMA_CHAR) {
            ...
            String converted = StringUtils.replace(value, GROUPING_SEPARATOR + CONSTANT.EMPTY_STRING, CONSTANT.EMPTY_STRING, StringComparison.Ordinal);
   ...
   /**
    * Parses a TimeSpan from a string.
    * TimeSpans are .NET structs and do not have an equivalent in Java.
    * They express time durations in ticks, which are units 1000 times smaller than milliseconds.
    *
    * @throws NullPointerException  An argument is null.
    * @throws NumberFormatException Parsed value is outside of configured range, or not of correct type.
    */
    ...
    * @throws NullPointerException An argument is null.
    */
   public static String replace(String value, String textToReplace, String replaceWithText, Locale locale, Collator collator, boolean caseSensitive)
   {
      if (value == null)
         throw new NullPointerException("value");
      if (textToReplace == null)
   ...
   /**
    * Returns a string array that contains the substrings of the text instance that
   ...
   public static String[] split(String text, char[] delimiters, StringSplitOptions options)
   {
      ...
      if (index > lastFound)
         ...
         if (index == lastFound && text.length() > 0 && contains(delimiters, text.charAt(text.length() - 1)))
            result.add(CONSTANT.EMPTY_STRING);
   ...
   /**
    * Returns a string array that contains the substrings of the text instance that
    * are delimited by elements provided in the specified Unicode string array.
    * When splitting strings, Ordinal string comparison is always used.
    *
    * @throws NullPointerException An argument is null.
    */
    ...
    * E.g. for 0d1h2m3s, using "d,h,m,s" as delimiters would return { 0,1,2,3 }.
    * Delimiters that are not found will be ignored.
    * E.g. for 0d1h2m3s, using "d,m,h,s" as delimiters would return { 0,1h2,3 } (i.e. h not found after m).
    * Uses Ordinal string comparison.
    * Does not continuously split in the same way split() does, uses anchor points instead.
    * When splitting strings, Ordinal string comparison is always used.
    *
    * @throws NullPointerException	 An argument is null.
    ...
    * Does not throw exceptions while parsing under any circumstances.
    */
   public static TryResult<LocalDateTime> tryParseDateTime(String value, LocalDateTime minValue, LocalDateTime maxValue, DateTimeFormatter fmt)
   {
      try {
