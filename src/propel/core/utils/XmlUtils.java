...
public final class XmlUtils
{
    ...
    * Be aware that this method does not preserve CDATA content.
    *
    ...
    * Uses StringMatch.Equals and OrdinalIgnoreCase string comparison.
   ...
   /**
    * Parses the node for a given attribute.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
   ...
   /**
    * Parses the node for an attribute that ends with a specific string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the attribute is not found, null is returned.
    */
   ...
   /**
    * Parses the node for an attribute that starts with a specific string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the attribute is not found, null is returned.
    */
   ...
   /**
    * Parses the node for an attribute that contains in its name a specific string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the attribute is not found, null is returned.
    */
    ...
    * Uses StringMatch.Equals and OrdinalIgnoreCase string comparison.
    * Returns the first node found or, if no node is found, null.
    *
    * @throws NullPointerException When an argument is null.
    */
   ...
   /**
    * Searches for a matching child node found under the given Node.
    * Use 0 for index to indicate that the first node found is to be returned, 1 for second, etc.
    * Uses StringMatch.Equals and OrdinalIgnoreCase string comparison.
   ...
   /**
    * Searches for a matching child node found under the given Node.
    * By default the first node found is returned, but this is configurable.
    * If none is found, null is returned.
    *
    * @throws NullPointerException When an argument is null.
    */
   ...
   /**
    * Parses the children of the given node and returns a child node matching the given name, skipping the first few matching nodes as specified.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the node is not found, or the index is invalid, null is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns a child node ending with the given name, skipping the first few matching nodes as specified.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the node is not found, or the index is invalid, null is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns a child node starting with the given name, skipping the first few matching nodes as specified.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the node is not found, or the index is invalid, null is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns the first child node containing in its name a specified string, skipping the first few matching nodes as specified.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If the node is not found, or the index is invalid, null is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns all matching children nodes.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
   ...
   /**
    * Parses the children of the given node and returns all children nodes ending with a specified string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If no nodes are found, an empty list is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns all children nodes starting with a specified string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If no nodes are found, an empty list is returned.
    */
   ...
   /**
    * Parses the children of the given node and returns all children nodes containing in their name a specified string.
    * The comparison type can be specified, e.g. OrdinalIgnoreCase.
    * If no nodes are found, an empty list is returned.
    */
   ...
   /**
    * Parses a child node found on the given Node.
    * Use 0 for index to indicate that the first node found is to be parsed, 1 for second, etc.
    * Uses StringMatch.Equals and OrdinalIgnoreCase string comparison.
    * If none is found or the index is not reached, null is returned.
    *
    * @throws NullPointerException When an argument is null.
