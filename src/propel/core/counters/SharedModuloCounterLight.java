 ...
 * Best used in very low contention scenarios (medium/high contention scenarios use too much CPU),
 * this is because it uses spin waiting instead of kernel mode sleep transitions.
 */
