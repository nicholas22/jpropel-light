...
public final class CONSTANT
{
    ...
    */
   public static final char[] HEX_DIGITS = new char[]{ZERO.charAt(0), ONE.charAt(0), TWO.charAt(0), THREE.charAt(0), FOUR.charAt(0), FIVE.charAt(0), SIX.charAt(0), SEVEN.charAt(0), EIGHT.charAt(0), NINE.charAt(0), A.charAt(0), B.charAt(0), C.charAt(0), D.charAt(0), E.charAt(0), F.charAt(0), a.charAt(0), b.charAt(0), c.charAt(0), d.charAt(0), e.charAt(0), f.charAt(0)};
   /**
    ...
    * It includes (as the last character) the '=' pad character, hence they are 65.
    */
   public static final char[] BASE64_DIGITS = new char[]{ZERO.charAt(0), ONE.charAt(0), TWO.charAt(0), THREE.charAt(0), FOUR.charAt(0), FIVE.charAt(0), SIX.charAt(0), SEVEN.charAt(0), EIGHT.charAt(0), NINE.charAt(0), A.charAt(0), B.charAt(0), C.charAt(0), D.charAt(0), E.charAt(0), F.charAt(0), G.charAt(0), H.charAt(0), I.charAt(0), J.charAt(0), K.charAt(0), L.charAt(0), M.charAt(0), N.charAt(0), O.charAt(0), P.charAt(0), Q.charAt(0), R.charAt(0), S.charAt(0), T.charAt(0), U.charAt(0), V.charAt(0), W.charAt(0), X.charAt(0), Y.charAt(0), Z.charAt(0), a.charAt(0), b.charAt(0), c.charAt(0), d.charAt(0), e.charAt(0), f.charAt(0), g.charAt(0), h.charAt(0), i.charAt(0), j.charAt(0), k.charAt(0), l.charAt(0), m.charAt(0), n.charAt(0), o.charAt(0), p.charAt(0), q.charAt(0), r.charAt(0), s.charAt(0), t.charAt(0), u.charAt(0), v.charAt(0), w.charAt(0), x.charAt(0), y.charAt(0), z.charAt(0), PLUS_SIGN_CHAR, FORWARD_SLASH_CHAR, EQUALS_SIGN_CHAR /* this is the 'pad' character */};
   /**
    ...
    */
   public static final char[] INVALID_FILENAME_CHARS_WINDOWS = StringUtils.concat(StringUtils.charRange(0, 32), new char[]{34, 42, 47, 58, 60, 62, 63, 92, 124});
   /**
    ...
    */
   public static final String OS_VERSION = System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") v" + System.getProperty("os.version");
}
